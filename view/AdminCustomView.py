...
class AdminCustomView(flask_admin.contrib.appengine.view.NdbModelView):
    ...
    column_editable_list = ['MinInstances', 'MaxInstances',
                            'UpContainerPendingRatio', 'UpYARNMemAvailPct',
                            'PreemptiblePct', 'DownYARNMemAvailePct']
    ...
    column_descriptions = dict(
        ...
        Cluster='Google Dataproc Cluster Name', Region='Cluster Region',
        UpContainerPendingRatio='The ratio of pending containers allocated to trigger scale out event of the cluster',
        UpYARNMemAvailPct='The percentage of remaining memory available to YARN to trigger scale out',
